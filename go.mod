module trendyol.com/security/appsec/devsecops/wolfichef
...
require (
	...
	github.com/wolfi-dev/wolfictl v0.0.0-20230714204142-5ae60f69fea1
...
replace k8s.io/api => k8s.io/api v0.28.0-alpha.3

replace k8s.io/kubectl => k8s.io/kubectl v0.28.0-alpha.3
...
replace github.com/docker/docker => github.com/docker/docker v23.0.0-rc.1+incompatible
...
require (
	...
	github.com/letsencrypt/boulder v0.0.0-20230717213829-7d66d6705461 // indirect
	...
	golang.org/x/build v0.0.0-20230718193232-4a55ba2180ea // indirect
...
replace trendyol.com/security/appsec/devsecops/wolfichef v0.0.0 => trendyol.com/security/appsec/devsecops/wolfichef v0.0.0
